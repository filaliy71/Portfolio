...
function HomePageBanner() {
  ...
  return (
    <div className="mb-20 max-md:mb-8 max-md:py-2 py-16">
      <motion.div
        variants={itemVariants}
        initial="hidden"
        animate="visible"
        className="rounded-full bg-blue-500 w-72 z-0 h-72 bg-opacity-75 blur-3xl absolute right-0 top-44"></motion.div>
      <motion.div
        variants={itemVariants}
        initial="hidden"
        animate="visible"
        className="rounded-full bg-blue-400 w-72 z-0 h-72 bg-opacity-75 blur-3xl absolute left-44 max-md:hidden"></motion.div>
      <div className="container mx-auto flex flex-col-reverse md:flex-row justify-around h-full items-center p-5">
        <motion.div
          ...
          <p className="font-semibold text-2xl md:text-3xl text-pretty mt-2 -tracking-1">
          ...
          <div className="flex justify-center md:justify-start space-x-4 mt-5">
            ...
            <Link
              target="_blank"
              href="https://www.upwork.com/freelancers/~01e102e0e4147202b8"
              className="cursor-pointer hover:scale-125 transition-all duration-300">
              <svg
                width={34}
                className="dark:fill-white fill-black"
      ...
      <motion.div
        className="flex justify-center max-md:py-12"
        variants={itemVariants}
        initial="hidden"
        animate="visible">
            ...
            {techLogos.map((logo, index) => (
              <li key={index}>
                <Image
                  ...
                  width={50}
                  height={50}
                  className="rounded-md max-md:w-12 max-md:h-12"
                  priority
                />
              </li>
            ))}
