...
function HomePageBanner() {
  ...
  return (
    <div className="mb-20 max-md:mb-8">
        ...
        <motion.div variants={itemVariants} initial="hidden" animate="visible" className="z-10 text-center md:text-left">
          <h1 className="text-4xl md:text-6xl font-bold z-10 flex justify-center md:justify-start items-center -tracking-4">
            ...
            <span className="inline-block ml-2">
              <Player src="/me_handwave.json" className="h-12 w-12 md:h-20 md:w-20" loop autoplay />
            </span>
          </h1>

          <h2 className="text-3xl md:text-4xl font-semibold bg-gradient-to-r from-sky-400 to-blue-700 bg-clip-text text-transparent -tracking-3">Full-Stack developer.</h2>
          <p className="font-semibold text-2xl md:text-3xl text-pretty  -tracking-2">
            I build things on the web. Based in
            <span className="bg-gradient-to-l from-green-800 via-red-500 to-red-700 bg-clip-text text-transparent"> Morocco </span>
            ,<br />I create dynamic and responsive applications.
            <br />
            Let&apos;s bring your ideas to life.
          </p>
          <div className="flex justify-center md:justify-start space-x-4 mt-5">
            <Link target="_blank" href="https://github.com/filaliy71" className="cursor-pointer hover:scale-125 transition-all duration-300">
              <svg viewBox="0 0 128 128" width={34} className="dark:fill-white fill-black">
            ...
            <Link target="_blank" href="https://linkedin.com/in/filali-youssef" className="cursor-pointer hover:scale-125 transition-all duration-300">
              <svg viewBox="0 0 128 128" width={34} className="dark:fill-white fill-black">
            ...
            <div className="mt-1 hover:scale-105 transition-all duration-300">
              <a href="/Resume.pdf" title="Download my CV" className="className-1 px-3 py-3 font-bold -tracking-1 rounded-full shadow bg-black dark:bg-slate-100 text-white dark:text-black">
                Download My CV
              </a>
            </div>
          </div>
        </motion.div>
        <motion.div variants={itemVariants} initial="hidden" animate="visible" className="md:mt-0 m d:mb-20">
      ...
      <motion.div className="flex justify-center max-md:py-12" variants={itemVariants} initial="hidden" animate="visible">
        <div className="inline-flex w-3/5 max-md:w-full flex-nowrap overflow-hidden [mask-image:_linear-gradient(to_right,transparent_0,_black_128px,_black_calc(100%-128px),transparent_100%)]">
          ...
          <ul className="flex animate-infinite-scroll items-center justify-center md:justify-start [&_img]:max-w-none [&_li]:mx-8" aria-hidden="true">
            {techLogos.map((logo, index) => (
              <li key={index}>
                <Image src={logo.src} alt={logo.alt} width={50} height={50} className="rounded-md max-md:w-12 max-md:h-12" loading="lazy" />
              </li>
            ))}
          </ul>
        </div>
