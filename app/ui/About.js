...
export default function About() {
  ...
  return (
    <motion.div
      ...
      className="px-4 md:px-20 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col lg:flex-row">
          <motion.div variants={itemVariants} className="mb-8 lg:mb-0 lg:mr-16">
            <Image
              ...
              width={480}
              height={480}
              alt="A picture related to coding"
          ...
          <motion.div
            variants={itemVariants}
            className="lg:text-left max-md:mt-16 max-md:text-center">
        ...
        <motion.div variants={itemVariants} className="p-6 mt-2 space-y-4">
          <h4 className="text-2xl font-bold first-letter:mb-4 border-b-2 border-blue-500 inline-block -tracking-2 text-black dark:text-white">
            Skills & Tools
          </h4>
          <motion.div variants={itemVariants}>
            ...
            <div className="pl-6">
              <p>
                <strong>Frontend:</strong> React, Next.js, Tailwind, MaterialUI,
                DaisyUI, Redux, GSAP, Framer
              </p>
              <p>
                <strong>Backend:</strong> Laravel, Node.js/Express
              </p>
            </div>
          </motion.div>
          ...
          <motion.div variants={itemVariants}>
            ...
            <div className="pl-6">
              <p>
                <strong>Languages & Technologies:</strong> HTML, CSS,
                JavaScript, PHP, WordPress, WebFlow
              </p>
              <p>
                <strong>Databases:</strong> MySQL, MongoDB
              </p>
              <p>
                <strong>APIs:</strong> REST APIs/JSON, React Hooks, Fetch/Axios,
                Inertia.js
              </p>
            </div>
          </motion.div>
          <motion.div variants={itemVariants}>
            ...
            <div className="pl-6">
              ...
              <p>
                <strong>CI/CD & DevOps:</strong> Docker, Jenkins, SonarQube
              </p>
              <p>
                <strong>Project Management:</strong> Jira, Click up
              </p>
              <p>
