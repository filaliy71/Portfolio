        ...
        <div className="flex flex-col lg:flex-row">
          ...
          <motion.div variants={itemVariants} className="max-w-xl lg:text-left">
            ...
            <p className="text-pretty font-medium">
              Hi, I&apos;m Youssef, a full-stack developer with a passion for creating clean and intuitive UI/UX designs. I primarily work with React and Next.js for front-end development, and Node.js and Laravel for the back-end.
              <br /> In addition to my core technologies, I have expertise in Git, Scrum, Docker, HTML, CSS, PHP, and Tailwind CSS. I&apos;m also skilled in using GSAP and Framer Motion for animations, JavaScript, Figma for design, and jQuery for dynamic web interactions.
            </p>
          </motion.div>
        </div>
        <motion.div variants={itemVariants} className="p-6 mt-2 space-y-4">
          <h4 className="text-2xl font-bold first-letter:mb-4 border-b-2 border-blue-500 inline-block -tracking-2 text-black dark:text-white">Skills & Tools</h4>

          <motion.div variants={itemVariants}>
            <h5 className="text-xl font-semibold text-blue-500 mb-2 -tracking-1">Frameworks and Libraries</h5>
            <p>React, NextJS, Tailwind, MaterialUI, DaisyUI, Redux, GSAP, Framer, Laravel, Nodejs/Express</p>
          </motion.div>
          ...
          <motion.div variants={itemVariants}>
            <h5 className="text-xl font-semibold text-blue-500 mb-2 -tracking-1">Tools</h5>
